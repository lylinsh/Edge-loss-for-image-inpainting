...
class EdgeGenerator(BaseNetwork):
    def __init__(self, residual_blocks=8, use_spectral_norm=True,
        ...
        #     spectral_norm(nn.ConvTranspose2d(in_channels=256, out_channels=128,
        #                     kernel_size=4, stride=2, padding=1), use_spectral_norm),
        #     nn.InstanceNorm2d(128, track_running_stats=False),
        #     nn.ReLU(True),
        #
        #     spectral_norm(nn.ConvTranspose2d(in_channels=128, out_channels=64,
        #                     kernel_size=4, stride=2, padding=1), use_spectral_norm),
        #     nn.InstanceNorm2d(64, track_running_stats=False),
        #     nn.ReLU(True),
        #
    ...
    def __init__(self, dim, dilation=1, use_spectral_norm=False):
        ...
        self.conv_block = nn.Sequential(
            ...
            spectral_norm(nn.Conv2d(in_channels=dim, out_channels=dim,
                            kernel_size=3, padding=0, dilation=dilation,
            ...
            spectral_norm(nn.Conv2d(in_channels=dim, out_channels=dim,
                            kernel_size=3, padding=0, dilation=1,
                            bias=not use_spectral_norm), use_spectral_norm),
            nn.InstanceNorm2d(dim, track_running_stats=False),
        )
...
if __name__ == "__main__":
    ...
    edgeGenerator_pretrained = torch.load("./../checkpoints/place2/EdgeModel_gen.pth", map_location='cpu')
    ...
    print(edgeGenerator_dict["middle.4.conv_block.1.weight_v"])
